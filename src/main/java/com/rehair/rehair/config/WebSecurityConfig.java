...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				.antMatchers("/","/account/join","/client/about","/client/reservation","/client/reservation_check","/client/notice","/client/membership","/client/event_detail","/css/**","/js/**","/images/**").permitAll()
